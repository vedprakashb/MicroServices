...
namespace ECommerce.Api.Orders.Providers
{
    public class OrdersProvider : IOrdersProvider
    {
        ...
        public async Task<(bool IsSuccess, IEnumerable<Models.Order> Orders, string Message)> GetOrdersAsync()
        {
            try
            {
        ...
        public async Task<(bool IsSuccess, IEnumerable<Models.Order> Orders, string Message)> GetOrdersAsync(int custmerId)
        {
            try
            {
                var orders = await dbContext.Orders.Where(c => c.CustomerId == custmerId).Include(o => o.Items).ToListAsync();
                if (orders != null )
                {
